 ...
 * @author will
 */
public class CustomInsertProvider extends MapperTemplate {
    ...
    public String insert(MappedStatement ms) {
        ...
        for (EntityColumn column : columnList) {
            ...
            if (column.getProperty().equals(SqlHelper.COLUMN_CREATE_DATE) || column.getProperty().equals(SqlHelper.COLUMN_MODIFY_DATE)) {
